...
const About: React.FC = () => {
  return (
         <section className='w-full relative min-h-[80vh] px-6 py-18 md:py-16'>
          ...
          <div className='max-w-300 h-full mx-auto grid grid-cols-1 lg:grid-cols-3 items-center gap-6 lg:gap-10'>
            <div className='h-[70%] hidden lg:block border-main bg-center bg-cover rounded-lg bg-[url(././assets/me.jpg)] bg-no-repeat bg-center flex justify-center items-center relative'>
            </div>
            <div className='flex flex-col col-span-2 gap-4 px-6 lg:px-0'>
              <h4 className='text-main w-full font-bold font-mono leading-[1.2] text-center'>ABOUT & BIO</h4>
