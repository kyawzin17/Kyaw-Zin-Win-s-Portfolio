...
const About= forwardRef<HTMLElement, AboutProp>(({id},ref) => {
  ...
  return (
         <section ref={ref} id={id} className='w-full min-h-[80vh] px-6 py-18 overflow-hidden md:py-16 relative'>
          ...
          <div className='max-w-300 h-full mx-auto grid grid-cols-1 lg:grid-cols-3 items-center gap-6 lg:gap-10'>
            ...
            <div className='flex flex-col col-span-2 gap-4 px-6 lg:px-0'>
              <h4 className='text-main w-full font-black leading-[1.2] text-center'>ABOUT & BIO</h4>
